    ...
    if (qu2=='yes'):
      ...
      if (que2=='yes'):
        ...
        if (questi2=='yes'):
          ...
          print('Julia:I willstart with the files and you will start with the passwords')
        ...
        if (quest2=='yes'):
          ...
          if(questi2=='No'):
           ...
           nt('Julia: Im ready, you need help? (yes/no) ')
